...
<head>
    ...
    <title>All Products - CET ONLINE</title>
        ...
        <style>
            body {
                background-image: url('webpic/bg2.png'); /* Set background image */
    ...
    <body>
        ...
        <div class="container">
            <div class="navbar">
                <div class="logo">
                <a href="home.html"><img src="webpic/logo3.png" width="125px"></a>
                </div>
                <nav>
                    <ul id="MenuItems">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <input type="hidden" name="product_name" value="CET ID LACE STYLE 1">
                <input type="hidden" name="product_price" value="60">
                <input type="hidden" name="product_image" value="webpic/n1.png">
